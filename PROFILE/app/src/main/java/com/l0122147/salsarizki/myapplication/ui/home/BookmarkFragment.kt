...
class BookmarkFragment() : Fragment(){
    ...
    companion object CREATOR : Parcelable.Creator<BookmarkFragment> {
        override fun createFromParcel(parcel: Parcel): BookmarkFragment {
            return BookmarkFragment(parcel)
        }

        override fun newArray(size: Int): Array<BookmarkFragment?> {
